...
> For the distinction between system context, task context and system prompt see [How Memory and Context Work](/en/admin/memory_audit/00_context_and_memory_flow/#1-what-is-context).
