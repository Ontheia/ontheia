...
Welcome to the central Ontheia documentation. This manual is divided into two main areas: Administration for system administrators and the User Manual for users.
...
- **[Configuration](./configuration/01_environment_variables.md):** Environment variables, backup, updates, reverse proxy, multiple instances.
...
- **[Environment Variables](./configuration/01_environment_variables.md):** Complete reference for all `.env` parameters, backup, updates, reverse proxy, and multiple instances.
