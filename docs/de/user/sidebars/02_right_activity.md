# Rechte Sidebar: Aktivität & Kontext
...
### Tool-Queue
Hier werden Werkzeug-Aufrufe gelistet, die auf deine **manuelle Freigabe** warten. Du siehst die Argumente, die die KI an das Tool senden möchte, und kannst diese prüfen, bevor du sie im Chat bestätigst.
...
### Memory-Treffer
Wenn der Agent Informationen aus dem **Langzeitgedächtnis** abruft, werden die relevantesten Textstellen hier als Vorschau angezeigt. So weißt du immer, auf welcher Wissensbasis die Antwort der KI beruht.
