...
- **Session-Lebensdauer:** 7 Tage, gleitend verlängert: Eine Sitzung, die weniger als 3,5 Tage Restlaufzeit hat, wird bei der nächsten authentifizierten Anfrage auf volle 7 Tage verschoben — eine Sitzung endet erst nach 7 Tagen ohne Nutzung. Serverseitiger Widerruf über das `revoked`-Flag; `POST /auth/logout` widerruft die aktuelle Sitzung.
