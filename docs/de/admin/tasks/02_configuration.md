...
> Zur Abgrenzung von System-Kontext, Task-Kontext und System-Prompt siehe [Wie Memory und Kontext funktionieren](/de/admin/memory_audit/00_context_and_memory_flow/#1-was-ist-kontext).
